    ...
    <header class="sticky top-0 z-50 bg-bg-secondary/90 backdrop-blur-md border-b border-border-default transition-colors">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('LOGO LOGO LAGI.png')); ?>" alt="Hariff Defense" class="h-8 w-auto object-contain">
                <div>
            ...
            <div class="flex items-center gap-3">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold text-white bg-accent-blue hover:bg-blue-700 transition-all shadow-sm">
                        <i class="bi bi-speedometer2"></i> Masuk Dasbor
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold text-white bg-accent-blue hover:bg-blue-700 transition-all shadow-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6 text-left">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-2">
                        <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-sm font-bold text-white bg-accent-blue hover:bg-blue-700 shadow-md transition-all">
                    ...
                    <div class="relative rounded-2xl overflow-hidden border border-border-default shadow-2xl bg-bg-secondary group">
                        <div id="hero-carousel" class="aspect-video sm:aspect-square relative overflow-hidden">
                            ...
                            <div class="carousel-slide absolute inset-0 transition-opacity duration-700 ease-in-out opacity-100" data-slide="0">
                                <img src="<?php echo e(asset('dok/BMC BMS.jpeg')); ?>" alt="BMC BMS Hariff" class="w-full h-full object-cover">
                            </div>
                            ...
                            <div class="carousel-slide absolute inset-0 transition-opacity duration-700 ease-in-out opacity-0 pointer-events-none" data-slide="1">
                                <img src="<?php echo e(asset('dok/RKAP 2026.jpg')); ?>" alt="Kegiatan Manufaktur Hariff" class="w-full h-full object-cover">
                            </div>
                            ...
                            <div class="carousel-slide absolute inset-0 transition-opacity duration-700 ease-in-out opacity-0 pointer-events-none" data-slide="2">
                                <img src="<?php echo e(asset('dok/WhatsApp Image 2025-06-17 at 10.04.02 AM copy.jpg')); ?>" alt="Pemeriksaan Quality Control" class="w-full h-full object-cover">
                            </div>
                            ...
                            <div class="carousel-slide absolute inset-0 transition-opacity duration-700 ease-in-out opacity-0 pointer-events-none" data-slide="3">
                                <img src="<?php echo e(asset('dok/WhatsApp Image 2025-06-17 at 10.04.02 AM-2 copy.jpg')); ?>" alt="Jalur Perakitan Hariff" class="w-full h-full object-cover">
                            </div>
    ...
    <footer class="mt-auto py-8 border-t border-border-default bg-bg-secondary text-center text-xs text-text-muted">
        <div class="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-2">
                <img src="<?php echo e(asset('LOGO LOGO LAGI.png')); ?>" alt="Hariff" class="h-6 w-auto">
                <span class="font-bold text-text-primary">PT Hariff Dipa Persada</span>
            </div>
            <p>&copy; <?php echo e(date('Y')); ?> ManufakTrack Portal. All rights reserved.</p>
        </div>
    </footer>
...
<?php /**PATH D:\MAGANG\WEB2-MAGANG\resources\views/landing.blade.php ENDPATH**/ ?>