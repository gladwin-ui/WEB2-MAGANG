...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dasbor'); ?> - Sistem Pelacakan Manufaktur PT Hariff</title>
    <!-- Google Fonts -->
    ...
    <header class="md:hidden flex items-center justify-between px-4 py-3 bg-white dark:bg-card border-b border-panel-border z-30 sticky top-0 shrink-0">
        <div class="flex items-center gap-3">
            <div class="w-8 h-8 relative bg-white rounded-lg p-0.5 shadow-sm flex items-center justify-center">
                <img src="<?php echo e(asset('logo-hariff.jpg')); ?>" alt="Logo PT Hariff" class="w-full h-full object-contain rounded brand-logo-light">
                <img src="<?php echo e(asset('logo-hariff.jpg')); ?>" alt="Logo PT Hariff" class="w-full h-full object-contain rounded brand-logo-dark hidden">
            </div>
            <div>
            ...
            <div class="sidebar-header-row flex items-center justify-between gap-3 mb-8">
                <div class="flex items-center gap-3 min-w-0">
                    <div class="w-11 h-11 shrink-0 relative bg-white rounded-xl p-1 shadow-sm flex items-center justify-center">
                        <img src="<?php echo e(asset('logo-hariff.jpg')); ?>" alt="Logo PT Hariff" class="w-full h-full object-contain rounded-lg brand-logo-light">
                        <img src="<?php echo e(asset('logo-hariff.jpg')); ?>" alt="Logo PT Hariff" class="w-full h-full object-contain rounded-lg brand-logo-dark hidden">
                    </div>
