        ...
        <div class="w-full max-w-md mx-auto my-auto py-10">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" class="w-full rounded-xl px-4 py-3.5 bg-gray-50 dark:bg-[#11233F] border border-gray-200 dark:border-gray-700 text-sm font-medium transition-all" placeholder="nama@hariff.co.id" value="{{ old('email') }}" required autofocus>
                </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 text-xs text-text-secondary">
                ...
                <a href="{{ route('register') }}" class="text-[#0046BF] dark:text-blue-400 font-bold hover:underline inline-flex items-center gap-1 ml-1 transition-colors">
