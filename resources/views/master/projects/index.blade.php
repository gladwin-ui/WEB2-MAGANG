...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h1 class="text-2xl font-black text-slate-800 tracking-tight uppercase">KELOLA MASTER PROJECT</h1>
        <p class="text-xs text-slate-500 font-mono tracking-wider uppercase">TAMBAHKAN ATAU PERBARUI REFERENSI DATA PROJECT PT HARIFF</p>
    </div>
