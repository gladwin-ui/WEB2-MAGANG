                            ...
                            <tr class="hover:bg-slate-50 transition-all">
                                ...
                                <td class="py-3.5 px-4">
                                    ...
                                    @elseif($bug->severity === 'Major')
                                        <span class="inline-flex text-[9px] font-bold font-mono bg-yellow-50 text-yellow-700 border border-yellow-200 px-2 py-0.5 rounded uppercase">MAJOR</span>
                                    @else
                                ...
                                <td class="py-3.5 px-4">
                                    @if($bug->sentiment_label === 'spam' || $bug->is_spam)
                                        <span class="inline-flex text-[9px] font-bold font-mono bg-red-100 text-red-700 border border-red-200 px-2 py-0.5 rounded uppercase" title="Reason: {{ $bug->spam_reason }}">SPAM WARNING</span>
                                    @elseif($bug->sentiment_label)
                                        <span class="inline-flex text-[9px] font-bold font-mono bg-green-50 text-green-700 border border-green-200 px-2 py-0.5 rounded uppercase">PASSED</span>
                                    @else
                                        <span class="inline-flex text-[9px] font-mono bg-slate-100 text-slate-500 border border-slate-200 px-2 py-0.5 rounded uppercase">UNANALYZED</span>
                                    @endif
                                </td>
